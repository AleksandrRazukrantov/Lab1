...
|-------------|---------------------------|-----------------|-------------------------|
| X (Число 1) | Целое положительное число |       1         | Допустимое для int (???)|
| A (Число 2) | Целое положительное число |       1         | Допустимое для int (???)|
| B (Число 2) | Целое положительное число |       1         | Допустимое для int (???)|
| C (Число 2) | Целое положительное число |       1         | Допустимое для int (???)|
